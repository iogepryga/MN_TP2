...
int main (int argc, char **argv) {
    ...
    printf("mnblas_ddot : %f\n",mnblas_ddot (VECSIZE_RESULTAT,V1d,1,V2d,1));
    printf("---------- test 2 : \n");
    ...
    #define NB_OPE_COMPLEXE 10
    #define NB_OPE_COMPLEXE_C 11
    ...
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        ...
        calcul_flop("mncblas_sdot : ", NB_OPE_REEL*VECSIZE_FLOPS ,end-start);
    }
    printf("<--------------------------------------------------------------->\n                      float sur NB_EXPE (%d)\n",NB_EXPE);
    ...
    calcul_flop("mncblas_sdot : ", NB_EXPE*NB_OPE_REEL*VECSIZE_FLOPS ,end-start);
    printf("<--------------------------------------------------------------->\n                      double\n");
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        printf("------------------------------------------------\n");
        start = _rdtsc();
        ...
        calcul_flop("mncblas_ddot : ", NB_OPE_REEL*VECSIZE_FLOPS ,end-start);
    }
    ...
    calcul_flop("mncblas_ddot : ", NB_EXPE*NB_OPE_REEL*VECSIZE_FLOPS ,end-start);
    printf("<--------------------------------------------------------------->\n                      complexe_float_t (mncblas_cdotu_sub)\n");
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        printf("------------------------------------------------\n");
        start = _rdtsc();
        ...
        calcul_flop("mncblas_cdotu_sub : ", NB_OPE_COMPLEXE*VECSIZE_FLOPS ,end-start);
    }
    ...
    calcul_flop("mncblas_cdotu_sub : ", NB_EXPE*NB_OPE_COMPLEXE*VECSIZE_FLOPS ,end-start);
    printf("<--------------------------------------------------------------->\n                      complexe_float_t (mncblas_cdotc_sub)\n");
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        printf("------------------------------------------------\n");
        start = _rdtsc();
        ...
        calcul_flop("mncblas_cdotc_sub : ", NB_OPE_COMPLEXE_C*VECSIZE_FLOPS ,end-start);
    }
    ...
    calcul_flop("mncblas_cdotc_sub : ", NB_EXPE*NB_OPE_COMPLEXE_C*VECSIZE_FLOPS ,end-start);
    ...
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        ...
        calcul_flop("mncblas_zdotu_sub : ", NB_OPE_COMPLEXE*VECSIZE_FLOPS ,end-start);
    }
    ...
    calcul_flop("mncblas_zdotu_sub : ", NB_EXPE*NB_OPE_COMPLEXE*VECSIZE_FLOPS ,end-start);
    printf("<--------------------------------------------------------------->\n                      complexe_double_t (mncblas_zdotc_sub)\n");
    for(int i = 0; i < NB_EXPE_VISIBLE; i++) {
        printf("------------------------------------------------\n");
        start = _rdtsc();
        ...
        calcul_flop("mncblas_zdotc_sub : ", NB_OPE_COMPLEXE_C*VECSIZE_FLOPS ,end-start);
    }
    ...
    calcul_flop("mncblas_zdotc_sub : ", NB_EXPE*NB_OPE_COMPLEXE_C*VECSIZE_FLOPS ,end-start);
