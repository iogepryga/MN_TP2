...
float  mnblas_sasum(const int N, const float *X, const int incX) { // NB OPE FLOTANTE = 2 MAX 1 MIN
...
double mnblas_dasum(const int N, const double *X, const int incX) { // NB OPE FLOTANTE = 2 MAX 1 MIN
...
float  mnblas_scasum(const int N, const void *X, const int incX) { // NB OPE FLOTANTE = 4 MAX 2 MIN
    register float sum = 0;
    for (register unsigned int i = 0; i < N ; i += incX) {
...
double mnblas_dzasum(const int N, const void *X, const int incX) { // NB OPE FLOTANTE = 4 MAX 2 MIN
    register double sum = 0;
    for (register unsigned int i = 0; i < N ; i += incX) {
